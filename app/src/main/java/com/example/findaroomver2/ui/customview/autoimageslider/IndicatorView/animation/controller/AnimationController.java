package com.example.findaroomver2.ui.customview.autoimageslider.IndicatorView.animation.controller;
...
import com.example.findaroomver2.ui.customview.autoimageslider.IndicatorView.utils.CoordinatesUtils;
...
public class AnimationController {
    ...
    private void colorAnimation() {
        ...
        BaseAnimation animation = valueController.color().with(unselectedColor, selectedColor).duration(animationDuration);
    ...
    private void scaleAnimation() {
        ...
        BaseAnimation animation = valueController.scale().with(unselectedColor, selectedColor, radiusPx, scaleFactor).duration(animationDuration);
    ...
    private void wormAnimation() {
        ...
        BaseAnimation animation = valueController.worm().with(from, to, radiusPx, isRightSide).duration(animationDuration);
    ...
    private void slideAnimation() {
        ...
        BaseAnimation animation = valueController.slide().with(from, to).duration(animationDuration);
    ...
    private void fillAnimation() {
        ...
        BaseAnimation animation = valueController.fill().with(unselectedColor, selectedColor, radiusPx, strokePx).duration(animationDuration);
    ...
    private void thinWormAnimation() {
        ...
        BaseAnimation animation = valueController.thinWorm().with(from, to, radiusPx, isRightSide).duration(animationDuration);
    ...
    private void dropAnimation() {
        ...
        BaseAnimation animation = valueController.drop().duration(animationDuration).with(widthFrom, widthTo, heightFrom, heightTo, radius);
    ...
    private void swapAnimation() {
        ...
        BaseAnimation animation = valueController.swap().with(from, to).duration(animationDuration);
    ...
    private void scaleDownAnimation() {
        ...
        BaseAnimation animation = valueController.scaleDown().with(unselectedColor, selectedColor, radiusPx, scaleFactor).duration(animationDuration);
