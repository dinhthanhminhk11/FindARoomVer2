...
public class Repository {
    ...
    public void editPost(Post post, String id, Consumer<PostResponse> consumer) {
        AndroidUtilities.runOnUIThread(new Runnable() {
            @Override
            public void run() {
                apiRequest.editPost(post, id).enqueue(new Callback<PostResponse>() {
                    @Override
                    public void onResponse(Call<PostResponse> call, Response<PostResponse> response) {
                        if (response.isSuccessful()) {
                            consumer.accept(response.body());
    ...
    public void adsPost(Post post, Consumer<PostResponse> consumer) {
        AndroidUtilities.runOnUIThread(new Runnable() {
            @Override
            public void run() {
                apiRequest.adsPost(post).enqueue(new Callback<PostResponse>() {
                    @Override
                    public void onResponse(Call<PostResponse> call, Response<PostResponse> response) {
                        if (response.isSuccessful()) {
                            consumer.accept(response.body());
    ...
    public void updateStatusRoom(Post post, Consumer<PostResponse> consumer) {
        AndroidUtilities.runOnUIThread(new Runnable() {
            @Override
            public void run() {
                apiRequest.updateStatusRoom(post).enqueue(new Callback<PostResponse>() {
                    @Override
                    public void onResponse(Call<PostResponse> call, Response<PostResponse> response) {
                        if (response.isSuccessful()) {
                            consumer.accept(response.body());
    ...
    public void getStatusPost(String idPost, Consumer<Boolean> consumer) {
        AndroidUtilities.runOnUIThread(new Runnable() {
            @Override
            public void run() {
                apiRequest.getStatusPost(idPost).enqueue(new Callback<Boolean>() {
                    @Override
    ...
    public void getStatusAds(String idPost, Consumer<Boolean> consumer) {
        AndroidUtilities.runOnUIThread(new Runnable() {
            @Override
            public void run() {
                apiRequest.getStatusPost(idPost).enqueue(new Callback<Boolean>() {
    ...
    public void updateAds(String id, String day, Consumer<String> consumer) {
        AndroidUtilities.runOnUIThread(new Runnable() {
            @Override
            public void run() {
                apiRequest.updateAds(id, day).enqueue(new Callback<String>() {
                    @Override
                    public void onResponse(Call<String> call, Response<String> response) {
                        if (response.isSuccessful()) {
                            consumer.accept(response.body());
